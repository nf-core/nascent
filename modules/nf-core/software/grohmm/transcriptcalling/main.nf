...
process GROHMM_TRANSCRIPTCALLING{
    ...
    conda     (params.enable_conda ? "conda-forge::r-base=4.0.3 conda-forge::r-optparse=1.6.6 conda-forge::r-rmariadb=1.0.6 bioconda::bioconductor-annotationdbi=1.42.1 bioconda::bioconductor-genomic-features=1.32.3 bioconda::bioconductor-txdb.hsapiens.ucsc.hg19.knowngene=3.2.2 bioconda::bioconductor-edgeR=3.32.0 bioconda::bioconductor-org.hs.eg.db=3.6.0 bioconda::bioconductor-grohmm=1.24.0"  : null)
