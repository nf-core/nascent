...
rule IMR18_meta_makeTagDirectory:
    ...
    """
    input:
        expand("results/2018-10-04/hg18/{unit}.sam",unit=IMR_SAMPLES)
    output:
...
rule GM18_meta_makeTagDirectory:
    ...
    """
    input:
        expand("results/2018-10-04/hg18/{unit}.sam",unit=GM_SAMPLES)
    output:
...
rule IMR_meta_makeTagDirectory:
    ...
    """
    input:
        expand("results/2018-10-04/hg19/{unit}.sam",unit=IMR_SAMPLES)
    output:
...
rule GM_meta_makeTagDirectory:
    ...
    """
    input:
        expand("results/2018-10-04/hg19/{unit}.sam",unit=GM_SAMPLES)
    output:
