...
[![Get help on Slack](http://img.shields.io/badge/slack-nf--core%20%23nascent-4A154B?logo=slack)](https://nfcore.slack.com/channels/nascent)

## Introduction

<!-- TODO nf-core: Write a 1-2 sentence summary of what data the pipeline is for and what it does -->
**nf-core/nascent** is a bioinformatics best-practise analysis pipeline for
...
3. Download the pipeline and test it on a minimal dataset with a single command:
    ...
    ```bash
    nextflow run nf-core/nascent -profile test,<docker/singularity/podman/conda/institute>
    ```
...
4. Start running your own analysis!
    ...
    ```bash
    nextflow run nf-core/nascent -profile <docker/singularity/podman/conda/institute> --input '*_R{1,2}.fastq.gz' --genome GRCh37
    ```

See [usage docs](https://nf-co.re/nascent/usage) for all of the available options when running the pipeline.
...
The nf-core/nascent pipeline comes with documentation about the pipeline: [usage](https://nf-co.re/nascent/usage) and [output](https://nf-co.re/nascent/output).
